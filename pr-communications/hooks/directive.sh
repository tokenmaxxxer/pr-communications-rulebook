...
PRODUCES="PRODUCES (required record fields): communications plan (RACE: research/action/communication/evaluation), key message (core+supporting+proof point), risk/Q&A prep (pre-approved)"
